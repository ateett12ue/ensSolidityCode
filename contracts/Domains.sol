...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Onion Name Service", "ONS"){
    ...
    function register(string calldata name) public payable{
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Onion name service", "image": "data:image/svg+xml;base64,',
        ...
        _tokenIds.increment();
        console.log("domain register for eth address", msg.sender);
    }
    ...
    function setRecord(string calldata name, string calldata recordStatement) public{
        require(domains[name] == msg.sender);
        records[name] = recordStatement;
    }
